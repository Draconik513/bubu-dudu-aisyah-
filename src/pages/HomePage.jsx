    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="z-10 text-center px-4">
        <motion.div
          ...
          className="mb-8"
        >
          <p className="text-lg text-pink-600 pt-4">Untuk yang terindah</p>
        ...
        >
          ...
          <p className="text-xl text-pink-600">🎉 9 September 2025 🎉</p>
          ...
          <div className="mt-8 p-4 bg-white/80 backdrop-blur-sm rounded-lg max-w-md mx-auto border border-pink-200">
            <p className="text-pink-800 italic">
              "Selamat ulang tahun Aiss🌹 jujur, di setiap hariku, ada aja momen
              aku inget kamu. Kamu itu bukti kalau kehadiran seseorang bisa
              bikin hidup lebih berwarna. Hari ini spesial banget, karena dunia
              dapet hadiah bernama kamu. Semoga semua kebaikan dan kebahagiaan
              yang kamu tebarkan balik ke kamu berkali lipat. Makasih udah bikin
              hariku sering lebih indah… aku care banget sama kamu, hari ini dan
              seterusnya."
            </p>
            <p className="mt-4 text-right text-pink-600 font-medium">- Aqim</p>
          </div>
        </motion.div>
